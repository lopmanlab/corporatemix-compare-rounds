...
```{r participant-files, echo=FALSE, include=FALSE}
...
# table 1 had race and hispanic separately, table 1.1 has racehispanic.
rm(t1a)
# library(table1)
...
#   select("participant_id","round") %>%
#   dplyr::group_by(participant_id, round) %>%
...
variables <- data.frame(var=c("participant_sex","participant_age_2", "family_structure",
                              "contact_location", "company", "racehispanic"), #  "contact_relation",
                        name=c("Sex","Age Group", "Family structure",
                               "Location of contact", "Company","Race/ Ethnicity")) %>% # "Relationship to contact"
