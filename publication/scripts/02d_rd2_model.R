...
df_rd2 <- df_all %>% # df_rd2 %>%
  ...
  # mutate(
  #   cnt_age_est_min = case_when(
  #     # changed from contact_age_1 to contact_age
  #     contact_age == "<1" ~ 0,
  #     contact_age == "1-9" ~ 1,
  #     contact_age == "10-19" ~ 10,
  #     contact_age == "20-29" ~ 20,
  #     contact_age == "30-39"~ 30,
  #     contact_age == "40-49" ~ 40,
  #     contact_age == "50-59" ~ 50,
  #     contact_age == "60-69" ~ 60,
  #     contact_age == "70+" ~ 70,
  #     TRUE~ NA_real_
  #   ),
  # 
  ...
  #     contact_age == "20-29" ~ 29,
  #     contact_age == "30-39"~ 39,
  #     contact_age == "40-49" ~ 49,
  #     contact_age == "50-59" ~ 59,
  #     contact_age == "60-69" ~ 69,
  #     contact_age == "70+" ~ 79,
  #     TRUE~ NA_real_
...
saveRDS(rd2_res_list, "data/model/rd2_res.RDS")
