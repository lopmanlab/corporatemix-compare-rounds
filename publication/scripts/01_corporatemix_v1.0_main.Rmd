...
# RD1 Q-index for only those ≥20 years
m1_rd1_df <- matrix(c(
  # 0.1,0.7,0.7,0.1,
  # 0.2,0.1,0.9,0.4,
  2.4,0.7,0.8,0.7,
...
m1_rd1_g <- graph_from_adjacency_matrix(m1_rd1_df, mode = "undirected")

# Calculate the Q-index
q_index_rd1 <- assortativity_degree(m1_rd1_g)
cat("RD1 Q-index (Assortativity):", q_index_rd1, "\n") # 0.30
...
m1_rd2_df <- matrix(c(
  ...
  nrow=4, ncol=4, byrow=T)
# Convert the matrix into a graph
m1_rd2_g <- graph_from_adjacency_matrix(m1_rd2_df, mode = "undirected")

# Calculate the Q-index
q_index_rd2 <- assortativity_degree(m1_rd2_g)
cat("RD2 Q-index (Assortativity):", q_index_rd2, "\n") # 0.03  
...
# Convert the matrix into a graph
m1_rd3_g <- graph_from_adjacency_matrix(m1_rd3_df, mode = "undirected")

# Calculate the Q-index
q_index_rd3 <- assortativity_degree(m1_rd3_g)
cat("RD3 Q-index (Assortativity):", q_index_rd3, "\n") # 0.39
...
m1_rd4_df <- matrix(c(
  # 0.2,0.9,0.6,0.2,
  # 0.4,0.3,1.1,0.5,
  4.7,2.1,1.8,2.3,2,3.6,2,1.8,
  1.6,2.3,4.5,4.1,
  0.5,0.8,1.1,2.3), nrow=4, ncol=4, byrow=T)
# Convert the matrix into a graph
m1_rd4_g <- graph_from_adjacency_matrix(m1_rd4_df, mode = "undirected")

# Calculate the Q-index
q_index_rd4 <- assortativity_degree(m1_rd4_g)
cat("RD4 Q-index (Assortativity):", q_index_rd4, "\n") # 0.19
...
source("../../publication/scripts/transmission_model.R")
